...
DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'data', 'modelnet_c')
...
class ScanObjectNN(Dataset):
    def __init__(self, args, split):
        self.h5_path = '/home/me.levi/scanobjectnn/h5_files/main_split/test_objectdataset.h5'
        #h5_path = os.path.join(DATA_DIR, split + '.h5')
        self.data, self.label = load_h5(self.h5_path)
        #if args.use_wolfmix:
        #    self.PointWOLF = PointWOLF(args)
